...
const AudioSyncWithText = () => {
  ...
  // created instance of player using uploaded audio file
  ...
  // converts lrc file and extracts into object that includes (starttime, endtime and text)
  ...
  // controls slider to seek player
  ...
  // converts extracted time into formated time to display
  ...
  // this fucntion helps to make current active line statys in same postion line in middle of container box
  ...
  // render all lyrics data ans set active line to bold
  const renderLyrics = () => {
